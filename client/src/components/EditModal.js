...
function EditModal({id,handleCloseModal}) {
  ...
  return (
    ...
    <div className="bg-white px-8 py-5 rounded md:w-1/3 w-3/4 box-border">
      <h2 className='text-3xl mb-3 text-center font-poppins'>Edit Product</h2>
      <form action="" className='font-montserrat text-sm'>
        ...
        <button id="edit" className='block w-full bg-secondary text-white py-1 px-5 rounded-full hover:bg-white hover:text-secondary border-2 border-secondary transition duration-200 box-border text-l mb-3 font-poppins' onClick={handleEdit}>Edit</button>
      </form>
    </div>
  </div>
  )
